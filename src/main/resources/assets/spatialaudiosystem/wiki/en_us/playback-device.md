...
![](bws:spatialaudiosystem:wiki/screens/playback-device__en_us.png)

The block that plays media written by the [Memory Device](memory-device.md). It plays a single medium, or several in order through the [♪ Schedule](playback-device/schedule.md).

[[TOC]]

## How to open

1. Place the **Playback Device** and **right-click** it
2. The first player to open it becomes the **owner**
...
| Element | Meaning |
|---|---|
| Jacket | Cover art of the medium in the media slot |
| Status | Playing / stopped |
| File, format | Details of the medium in the media slot |
| Range slot (left) | Holds the [Range Board](tools/range-board.md) |
| Media slot | Holds the medium played by **▶** |
